...
export default function PlasmaWave(props) {
  ...
  useEffect(() => {
    ...
    // Only render while the canvas is actually on-screen — a WebGL loop running
    // behind scrolled-away sections needlessly steals GPU and janks the rest of
    // the page (e.g. the folder animation far below the hero).
    let visible = true;
